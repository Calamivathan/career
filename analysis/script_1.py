# Now let's create a comprehensive salary parsing utility and fix the skills extraction

salary_utils_content = """#!/usr/bin/env python3
\"\"\"
...
with open('data_utils.py', 'w') as f:
    f.write(salary_utils_content)

print("✓ Created comprehensive data_utils.py for proper data parsing")
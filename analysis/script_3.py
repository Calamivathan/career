# Let's create the analysis directory and then create the fixed analysis file
import os

# Create analysis directory if it doesn't exist
os.makedirs('analysis', exist_ok=True)

# Now create the fixed skills analysis
fixed_skills_analysis = """#!/usr/bin/env python3
\"\"\"
...
from data_utils import extract_skills, parse_salary
...
with open('analysis/top_skills_by_job_type.py', 'w') as f:
    f.write(fixed_skills_analysis)

print("✓ Created analysis directory and fixed top_skills_by_job_type.py")
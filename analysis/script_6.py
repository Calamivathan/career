# Let's also fix the top_paying_jobs analysis to use the new salary parsing

fixed_top_paying_jobs = """#!/usr/bin/env python3
\"\"\"
...
from data_utils import parse_salary
...
# Save the fixed top paying jobs analysis
with open('analysis/top_paying_jobs.py', 'w') as f:
    f.write(fixed_top_paying_jobs)

print("✓ Fixed analysis/top_paying_jobs.py with improved salary parsing")
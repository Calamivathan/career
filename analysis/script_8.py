# Let's create multiple analysis modules in one go

# Analysis 6: Experience Level Distribution
analysis_6_content = """#!/usr/bin/env python3
\"\"\"
...
with open('analysis/experience_level_distribution.py', 'w') as f:
    f.write(analysis_6_content)

print("✓ Created analysis/experience_level_distribution.py")